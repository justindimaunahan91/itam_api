...
try {
    switch ($method) {
        ...
        case 'POST':
            ...
            if (isset($data['company_id'], $data['department_id'], $data['unit_id'], $data['user_id'], $data['asset_id'], $data['date_borrowed'], $data['due_date'],$data['duration'], $data['asset_condition_id'], $data['remarks'] )) {
                $result = $borrowedAssets->insertBorrowedAsset($data['company_id'], $data['department_id'], $data['unit_id'], $data['user_id'], $data['asset_id'], $data['date_borrowed'], $data['due_date'], $data['duration'], $data['asset_condition_id'], $data['remarks']  ?? null);
                sendJsonResponse($result);
            } else {
